...
import {ministriesData} from "~/pages/recruitment/ministries_data";
import RecruitForm from "~/pages/recruitment/recruitment_form";
import ArrowLinkButton from "~/pages/recruitment/arrow_link_button";
import TeamCardWide from "~/pages/recruitment/team_card_wide";
import DirectGradientLine from "~/pages/recruitment/direct_gradient_line";
import MinistryCard from "~/pages/recruitment/ministry_card";
