...
function DirectGradientLine() {
    return (
        <div className="w-full h-6 bg-gradient-to-b from-black to-transparent flex items-center justify-center relative bottom-2">
            <div className="w-full max-w-lg h-6">
